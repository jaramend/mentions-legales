...
/**
* Construit le texte des mentions légales
*
* @since 1.0.0
*
*/
function mentions_legales_shortcode() {
    ...
    if(get_option('mentions_legales_cnil') == "Oui") {
        ...
        $cnil = '<p>Le site n\'est pas déclaré à la CNIL car il ne recueille pas d\'informations personnelles.</p><p>Les bases de données sont protégées par les dispositions de la loi du 1er juillet 1998 transposant la directive 96/9 du 11 mars 1996 relative à la protection juridique des bases de données.</p>';
    }
...
*
*/
function mentions_legales_register_shortcode() {
    
    add_shortcode('mentions_legales', 'mentions_legales_shortcode');
    
}
add_action('init', 'mentions_legales_register_shortcode');